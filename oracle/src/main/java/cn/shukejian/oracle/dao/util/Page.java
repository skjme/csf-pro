...
public class Page<T> {
    ...
    private String returnURL;//页面路径
    protected boolean autoRows = false;//是否需要rows属性

    protected List<Map<String, Object>> footer = new ArrayList<>();

    private Map<String, Object> pagination = new LinkedMap();
    ...
    public long setTotalPages(long totalPages) {
    ...
    public void addFooter(Map<String, Object> footer) {
