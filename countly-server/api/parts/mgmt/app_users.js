 ...
 * @returns {boolean}
 */
usersApi.updateUserDetail =  function(params) {

    var updatedUser = params.qstring.user_details;

    common.db.collection('app_users' + params.app_id).findOne({'_id': params.app_user_id}, function(err, res) {
        console.log(res)
        common.db.collection('app_users' + params.app_id).update({ '_id': params.app_user_id }, { '$set': updatedUser }, { safe: true },
            function(err, res) {
                console.log(res)
        });
    });
