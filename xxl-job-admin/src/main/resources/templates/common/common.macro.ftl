...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>DHZ</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>AT集团</b> ${I18n.admin_version}
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2012-${.now?string('yyyy')} &nbsp;
                <a href="https://sa.dhaizi.com/" target="_blank" >懂孩子</a>
				&nbsp;
                <!-- a href="https://sa.dhaizi.com" target="_blank" >admin</a -->
