...
const processRequest = (params) => {
    ...
    console.log("qstring=", params.qstring);
    console.log("apiPath=", params.apiPath);
    console.log("fullPath=", params.fullPath);
    console.log("==============================");
    ...
    reloadConfig().then(function() {
        ...
        if (!params.cancelRequest) {
            ...
            case '/i': {
                ...
                // 事件处理  JSON array as string containing event objects
                ...
                // user_details  JSON object as string containing information about users
                if (params.qstring.user_details && typeof params.qstring.user_details === "string") {
                    try {
                        params.qstring.user_details = JSON.parse(params.qstring.user_details);
                    }
                    catch (SyntaxError) {
                        console.log('Parse events JSON failed', params.qstring.user_details, params.req.url, params.req.body);
                    }
                }
